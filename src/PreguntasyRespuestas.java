...
public class PreguntasyRespuestas
{
	...
	private static final String PREGUNTAR_CURSO = "¿En qué curso estás amigo?";
	private static final String PREGUNTAR_EDAD = "¿Cuántos años tienes amiguito?";
	private static final String PREGUNTAR_NOMBRE = "¿Cómo te llamas amiguin?";
